...
func main() {
	...
	case day == 16:
		result = aoc.Sixteen(lines, part)
	case day == 17:
		log.Println("Seventeen result:", aoc.Seventeen(lines, part))
	case day == 18:
	...
	case day == 21:
		result = aoc.Twentyone(lines, part)
	case day == 22:
		result = aoc.Twentytwo(lines, part)
	case day == 23:
		result = aoc.Twentythree(lines, part)
	case day == 24:
		result = aoc.Twentyfour(lines, part)
	case day == 25:
		result = aoc.Twentyfive(lines)
	}
